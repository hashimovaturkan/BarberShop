        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstServiceId = table.Column<int>(type: "int", nullable: true),
                    SecondServiceId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_Filials_FilialId",
                        column: x => x.FilialId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reservations_Services_FirstServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_FilialId",
                table: "Reservations",
                column: "FilialId");

            migrationBuilder.CreateIndex(
                name: "IX_Reservations_FirstServiceId",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_SecondServiceId",
                table: "Reservations",
